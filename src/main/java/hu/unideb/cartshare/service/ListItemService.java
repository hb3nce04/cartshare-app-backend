...
public class ListItemService {
     ...
     */
    public ListItemResponseDto create(final CreateListItemRequestDto dto) {
        hu.unideb.cartshare.model.entity.List foundList =
                listService.findById(UUID.fromString(dto.getListId()));
    ...
    public void update(
            final UUID id,
            final UpdateListItemRequestDto dto) {
        ListItem foundListItem = findById(id);
        hu.unideb.cartshare.model.entity.List foundList =
                listService.findByItem(foundListItem);
     ...
     */
    public Set<ListItemResponseDto> findItemsByListId(final UUID id) {
        hu.unideb.cartshare.model.entity.List foundList =
                listService.findById(id);
